namespace XPT.Core.Scripting.Base {
    internal static class ValidationForScripting {
        ...
        /// <summary>
        /// Ensures that the var name can be used by the scripting engine. Valid names must not be null or contain
        /// whitespace, must begin with an alphabetical or underscore character, and must only contain alphanumeric
        /// characters and underscore characters.
        /// </summary>
