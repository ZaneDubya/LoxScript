...
namespace GenerateGrammar {
    ...
    /// 
    /// The effect of running this program is that it will overwrite XPT/Grammar/Expr.cs and 
    /// XPT/Grammar/Stmt.cs in the main XPT program.
    /// 
    /// The resulting classes contain the objects that will make up the AST. The AST is generated by the parser,
    /// relying on XPT/Grammar/Keywords.cs, and is invoked by the interpreter.
    /// </summary>
    static class Program {
        ...
        private static string DefineAst(string baseName, bool hasVisitorType, IEnumerable<string> types) {
            ...
            writer.AppendLine("using XPT.Compiling;");
            writer.AppendLine("using System.Collections.Generic;");
            writer.AppendLine();
            writer.AppendLine("namespace XPT.Interpreter {");
